...
fileCheck(){
    echo "/home/dev/ori/CDOM/$1/$2/$3/$4 grep COMS_GOCI_L2A_GA_$1$2$3$4.CDOM.BI.JPG"
    ls /home/dev/ori/CDOM/$1/$2/$3/$4 | grep COMS_GOCI_L2A_GA_$1$2$3$4.CDOM.BI.JPG\
    && return 1\
    || return 0;
}
